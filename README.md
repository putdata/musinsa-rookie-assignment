...
### Phase 2 — Redis Fast Rejection + 캐싱
...
#### Phase 0~1 (enrollment-rush, 500 VU 직접 수강신청)
...
**3. Gradle bootRun vs java -jar 성능 차이**
...
Phase 1 (최적)        avg 24.2ms
    │ Redis fast rejection + 캐싱
Phase 2 (Redis)       재측정 예정
    │ 대기열 패러다임 전환
Phase 3 (대기열)      재측정 예정
```
