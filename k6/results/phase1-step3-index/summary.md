...
|------|-------------------|-------------------|---------------------|------------------|
| iterations/s | 1,310 | 1,474 | **1,494** | 1,477.6 |
| p90 | 198.53ms | 138ms | **132.26ms** | 171.1ms |
| p95 | 259.01ms | 167.03ms | **153.85ms** | 204.99ms |
| avg | 79.32ms | 46.02ms | **44.12ms** | 57.44ms |
| 총 iterations | 298,796 | 368,407 | **373,278** | 340,827 |
...
### 인덱스 추가 후 오히려 소폭 하락
- Step 2 대비 iterations/s가 1,494 → 1,477.6으로 약 1.1% 감소
- p95도 153.85ms → 204.99ms로 증가
...
- **주요 기여 요인**: HikariCP 풀 확대가 핵심 (+12.5%), OSIV OFF + 배치가 추가 개선
